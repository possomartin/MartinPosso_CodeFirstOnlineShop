...
using MartinPosso_CodeFirstOnlineShop.Models;

namespace MartinPosso_CodeFirstOnlineShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,Description,Stock,ProductCode,SupplierID,CategoryID,Image")] Product product)
        {
            ...
            {
                ModelState.AddModelError("ProductCode","El producto codigo del producto ya existe");
            }
